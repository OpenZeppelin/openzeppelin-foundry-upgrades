...
:xref-UnsafeUpgrades-getAdminAddress-address-: xref:#UnsafeUpgrades-getAdminAddress-address-
:xref-UnsafeUpgrades-getImplementationAddress-address-: xref:#UnsafeUpgrades-getImplementationAddress-address-
:xref-UnsafeUpgrades-getBeaconAddress-address-: xref:#UnsafeUpgrades-getBeaconAddress-address-
...
:getAdminAddress: pass:normal[xref:#UnsafeUpgrades-getAdminAddress-address-[`++getAdminAddress++`]]
:getImplementationAddress: pass:normal[xref:#UnsafeUpgrades-getImplementationAddress-address-[`++getImplementationAddress++`]]
:getBeaconAddress: pass:normal[xref:#UnsafeUpgrades-getBeaconAddress-address-[`++getBeaconAddress++`]]
...
* {xref-UnsafeUpgrades-getAdminAddress-address-}[`++getAdminAddress(proxy)++`]
* {xref-UnsafeUpgrades-getImplementationAddress-address-}[`++getImplementationAddress(proxy)++`]
* {xref-UnsafeUpgrades-getBeaconAddress-address-}[`++getBeaconAddress(proxy)++`]
...
[.contract-item]
[[UnsafeUpgrades-getAdminAddress-address-]]
==== `[.contract-item-name]#++getAdminAddress++#++(address proxy) → address++` [.item-kind]#internal#
...
[.contract-item]
[[UnsafeUpgrades-getImplementationAddress-address-]]
==== `[.contract-item-name]#++getImplementationAddress++#++(address proxy) → address++` [.item-kind]#internal#
...
[.contract-item]
[[UnsafeUpgrades-getBeaconAddress-address-]]
==== `[.contract-item-name]#++getBeaconAddress++#++(address proxy) → address++` [.item-kind]#internal#
